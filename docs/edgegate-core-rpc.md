...
- [v2/core_msg_options/core_options.proto](#v2_core_msg_options_core_options-proto)
    - [CoreOptions](#core_msg_options-CoreOptions)
    - [DNSOptions](#core_msg_options-DNSOptions)
    - [InboundOptions](#core_msg_options-InboundOptions)
    - [IntRange](#core_msg_options-IntRange)
    - [MuxOptions](#core_msg_options-MuxOptions)
    - [RouteOptions](#core_msg_options-RouteOptions)
    - [Rule](#core_msg_options-Rule)
    - [TLSTricks](#core_msg_options-TLSTricks)
    - [URLTestOptions](#core_msg_options-URLTestOptions)
    - [WarpAccount](#core_msg_options-WarpAccount)
    - [WarpOptions](#core_msg_options-WarpOptions)
    - [WarpWireguardConfig](#core_msg_options-WarpWireguardConfig)
  
    - [DomainStrategy](#core_msg_options-DomainStrategy)
...
- [v2/hcore/hcore.proto](#v2_hcore_hcore-proto)
    - [ChangeCoreSettingsRequest](#hcore-ChangeCoreSettingsRequest)
...
<a name="v2_core_msg_options_core_options-proto"></a>
<p align="right"><a href="#top">Top</a></p>

## v2/core_msg_options/core_options.proto



<a name="core_msg_options-CoreOptions"></a>

### CoreOptions
CoreOptions defines the configuration options for the Edgegate application.
...
| rules | [Rule](#core_msg_options-Rule) | repeated | List of routing rules for traffic management. |
| warp | [WarpOptions](#core_msg_options-WarpOptions) |  | Configuration options for Warp. |
| warp2 | [WarpOptions](#core_msg_options-WarpOptions) |  | Additional configuration options for a second Warp instance. |
| mux | [MuxOptions](#core_msg_options-MuxOptions) |  | Configuration options for multiplexing. |
| tls_tricks | [TLSTricks](#core_msg_options-TLSTricks) |  | Options for TLS tricks. |
| dns_options | [DNSOptions](#core_msg_options-DNSOptions) |  | DNS-related options. |
| inbound_options | [InboundOptions](#core_msg_options-InboundOptions) |  | Inbound connection options. |
| url_test_options | [URLTestOptions](#core_msg_options-URLTestOptions) |  | URL test configuration options. |
| route_options | [RouteOptions](#core_msg_options-RouteOptions) |  | Routing-related options. |
...
<a name="core_msg_options-DNSOptions"></a>
...
| remote_dns_domain_strategy | [DomainStrategy](#core_msg_options-DomainStrategy) |  | Strategy for resolving domains with remote DNS. |
| direct_dns_address | [string](#string) |  | Direct DNS server address. |
| direct_dns_domain_strategy | [DomainStrategy](#core_msg_options-DomainStrategy) |  | Strategy for resolving domains with direct DNS. |
...
<a name="core_msg_options-InboundOptions"></a>
...
<a name="core_msg_options-IntRange"></a>
...
<a name="core_msg_options-MuxOptions"></a>
...
<a name="core_msg_options-RouteOptions"></a>
...
| ipv6_mode | [DomainStrategy](#core_msg_options-DomainStrategy) |  | Strategy for handling IPv6 addresses. |
...
<a name="core_msg_options-Rule"></a>
...
<a name="core_msg_options-TLSTricks"></a>
...
| fragment_size | [IntRange](#core_msg_options-IntRange) |  | Size of fragments to be used. |
| fragment_sleep | [IntRange](#core_msg_options-IntRange) |  | Sleep time between fragments. |
...
| padding_size | [IntRange](#core_msg_options-IntRange) |  | Size of padding to be used. |
...
<a name="core_msg_options-URLTestOptions"></a>
...
<a name="core_msg_options-WarpAccount"></a>
...
<a name="core_msg_options-WarpOptions"></a>
...
| wireguard_config | [WarpWireguardConfig](#core_msg_options-WarpWireguardConfig) |  | Configuration for WireGuard (defined elsewhere). |
| fake_packets | [string](#string) |  | Fake packet configuration. |
| fake_packet_size | [IntRange](#core_msg_options-IntRange) |  | Size of fake packets. |
| fake_packet_delay | [IntRange](#core_msg_options-IntRange) |  | Delay for sending fake packets. |
...
| account | [WarpAccount](#core_msg_options-WarpAccount) |  | Account details for Warp (defined elsewhere). |
...
<a name="core_msg_options-WarpWireguardConfig"></a>
...
<a name="core_msg_options-DomainStrategy"></a>
...
<a name="hcore-ChangeCoreSettingsRequest"></a>

### ChangeCoreSettingsRequest



| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| core_settings_json | [string](#string) |  |  |
...
| ChangeCoreSettings | [ChangeCoreSettingsRequest](#hcore-ChangeCoreSettingsRequest) | [CoreInfoResponse](#hcore-CoreInfoResponse) |  |
...
| override_core_options | [core_msg_options.CoreOptions](#core_msg_options-CoreOptions) |  | Override core options. |
