...
func (s *CoreRPCServer) GetSystemProxyStatus(ctx context.Context, empty *hcommon.Empty) (*SystemProxyStatus, error) {
...
func (s *CoreRPCServer) SetSystemProxyEnabled(ctx context.Context, in *SetSystemProxyEnabledRequest) (*hcommon.Response, error) {
