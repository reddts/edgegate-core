...
const (
	...
	Core_ChangeCoreSettings_FullMethodName    = "/hcore.Core/ChangeCoreSettings"
...
type CoreClient interface {
	...
	CoreInfoListener(ctx context.Context, in *hcommon.Empty, opts ...grpc.CallOption) (Core_CoreInfoListenerClient, error)
	OutboundsInfo(ctx context.Context, in *hcommon.Empty, opts ...grpc.CallOption) (Core_OutboundsInfoClient, error)
	MainOutboundsInfo(ctx context.Context, in *hcommon.Empty, opts ...grpc.CallOption) (Core_MainOutboundsInfoClient, error)
	GetSystemInfo(ctx context.Context, in *hcommon.Empty, opts ...grpc.CallOption) (Core_GetSystemInfoClient, error)
	Setup(ctx context.Context, in *SetupRequest, opts ...grpc.CallOption) (*hcommon.Response, error)
	Parse(ctx context.Context, in *ParseRequest, opts ...grpc.CallOption) (*ParseResponse, error)
	ChangeCoreSettings(ctx context.Context, in *ChangeCoreSettingsRequest, opts ...grpc.CallOption) (*CoreInfoResponse, error)
	...
	LogListener(ctx context.Context, in *hcommon.Empty, opts ...grpc.CallOption) (Core_LogListenerClient, error)
}
...
func (c *coreClient) CoreInfoListener(ctx context.Context, in *hcommon.Empty, opts ...grpc.CallOption) (Core_CoreInfoListenerClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Core_ServiceDesc.Streams[0], Core_CoreInfoListener_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &coreCoreInfoListenerClient{ClientStream: stream}
...
func (c *coreClient) OutboundsInfo(ctx context.Context, in *hcommon.Empty, opts ...grpc.CallOption) (Core_OutboundsInfoClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Core_ServiceDesc.Streams[1], Core_OutboundsInfo_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &coreOutboundsInfoClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func (c *coreClient) MainOutboundsInfo(ctx context.Context, in *hcommon.Empty, opts ...grpc.CallOption) (Core_MainOutboundsInfoClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Core_ServiceDesc.Streams[2], Core_MainOutboundsInfo_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &coreMainOutboundsInfoClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func (c *coreClient) GetSystemInfo(ctx context.Context, in *hcommon.Empty, opts ...grpc.CallOption) (Core_GetSystemInfoClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Core_ServiceDesc.Streams[3], Core_GetSystemInfo_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &coreGetSystemInfoClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func (c *coreClient) ChangeCoreSettings(ctx context.Context, in *ChangeCoreSettingsRequest, opts ...grpc.CallOption) (*CoreInfoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CoreInfoResponse)
	err := c.cc.Invoke(ctx, Core_ChangeCoreSettings_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coreClient) LogListener(ctx context.Context, in *hcommon.Empty, opts ...grpc.CallOption) (Core_LogListenerClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Core_ServiceDesc.Streams[4], Core_LogListener_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &coreLogListenerClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type CoreServer interface {
	...
	CoreInfoListener(*hcommon.Empty, Core_CoreInfoListenerServer) error
	OutboundsInfo(*hcommon.Empty, Core_OutboundsInfoServer) error
	MainOutboundsInfo(*hcommon.Empty, Core_MainOutboundsInfoServer) error
	GetSystemInfo(*hcommon.Empty, Core_GetSystemInfoServer) error
	Setup(context.Context, *SetupRequest) (*hcommon.Response, error)
	Parse(context.Context, *ParseRequest) (*ParseResponse, error)
	ChangeCoreSettings(context.Context, *ChangeCoreSettingsRequest) (*CoreInfoResponse, error)
	// rpc GenerateConfig (GenerateConfigRequest) returns (GenerateConfigResponse);
	...
	LogListener(*hcommon.Empty, Core_LogListenerServer) error
...
func (UnimplementedCoreServer) CoreInfoListener(*hcommon.Empty, Core_CoreInfoListenerServer) error {
	return status.Errorf(codes.Unimplemented, "method CoreInfoListener not implemented")
}
func (UnimplementedCoreServer) OutboundsInfo(*hcommon.Empty, Core_OutboundsInfoServer) error {
	return status.Errorf(codes.Unimplemented, "method OutboundsInfo not implemented")
}
func (UnimplementedCoreServer) MainOutboundsInfo(*hcommon.Empty, Core_MainOutboundsInfoServer) error {
	return status.Errorf(codes.Unimplemented, "method MainOutboundsInfo not implemented")
}
func (UnimplementedCoreServer) GetSystemInfo(*hcommon.Empty, Core_GetSystemInfoServer) error {
...
func (UnimplementedCoreServer) ChangeCoreSettings(context.Context, *ChangeCoreSettingsRequest) (*CoreInfoResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ChangeCoreSettings not implemented")
}
...
func (UnimplementedCoreServer) LogListener(*hcommon.Empty, Core_LogListenerServer) error {
...
func _Core_CoreInfoListener_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(CoreServer).CoreInfoListener(m, &coreCoreInfoListenerServer{ServerStream: stream})
}
...
func _Core_OutboundsInfo_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(CoreServer).OutboundsInfo(m, &coreOutboundsInfoServer{ServerStream: stream})
}
...
func _Core_MainOutboundsInfo_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(CoreServer).MainOutboundsInfo(m, &coreMainOutboundsInfoServer{ServerStream: stream})
}
...
func _Core_GetSystemInfo_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(CoreServer).GetSystemInfo(m, &coreGetSystemInfoServer{ServerStream: stream})
}
...
func _Core_ChangeCoreSettings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ChangeCoreSettingsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CoreServer).ChangeCoreSettings(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Core_ChangeCoreSettings_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoreServer).ChangeCoreSettings(ctx, req.(*ChangeCoreSettingsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Core_LogListener_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(CoreServer).LogListener(m, &coreLogListenerServer{ServerStream: stream})
}
...
var Core_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ChangeCoreSettings",
			Handler:    _Core_ChangeCoreSettings_Handler,
		},
		{
