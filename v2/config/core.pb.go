...
var file_core_proto_goTypes = []interface{}{
	(*ParseConfigRequest)(nil),     // 0: CoreOptions.ParseConfigRequest
	(*ParseConfigResponse)(nil),    // 1: CoreOptions.ParseConfigResponse
	(*GenerateConfigRequest)(nil),  // 2: CoreOptions.GenerateConfigRequest
	(*GenerateConfigResponse)(nil), // 3: CoreOptions.GenerateConfigResponse
}
var file_core_proto_depIdxs = []int32{
	0, // 0: CoreOptions.CoreService.ParseConfig:input_type -> CoreOptions.ParseConfigRequest
	2, // 1: CoreOptions.CoreService.GenerateFullConfig:input_type -> CoreOptions.GenerateConfigRequest
	1, // 2: CoreOptions.CoreService.ParseConfig:output_type -> CoreOptions.ParseConfigResponse
	3, // 3: CoreOptions.CoreService.GenerateFullConfig:output_type -> CoreOptions.GenerateConfigResponse
