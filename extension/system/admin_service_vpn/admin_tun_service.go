...
import (
	...
	ex "github.com/reddts/edgegate-core/extension"
	tunnelservice "github.com/reddts/edgegate-core/v2/hcore/tunnelservice"
...
func init() {
	ex.RegisterExtension(
		ex.ExtensionFactory{
			Id:          "github.com/reddts/edgegate-core/extension/system/admin_service_vpn", // Package identifier
