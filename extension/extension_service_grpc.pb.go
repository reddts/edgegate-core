...
type ExtensionHostServiceClient interface {
	...
	Connect(ctx context.Context, in *ExtensionRequest, opts ...grpc.CallOption) (ExtensionHostService_ConnectClient, error)
...
func (c *extensionHostServiceClient) Connect(ctx context.Context, in *ExtensionRequest, opts ...grpc.CallOption) (ExtensionHostService_ConnectClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	...
	x := &extensionHostServiceConnectClient{ClientStream: stream}
...
type ExtensionHostService_ConnectClient interface {
	Recv() (*ExtensionResponse, error)
	grpc.ClientStream
}

type extensionHostServiceConnectClient struct {
	grpc.ClientStream
}

func (x *extensionHostServiceConnectClient) Recv() (*ExtensionResponse, error) {
	m := new(ExtensionResponse)
...
type ExtensionHostServiceServer interface {
	...
	Connect(*ExtensionRequest, ExtensionHostService_ConnectServer) error
...
// UnimplementedExtensionHostServiceServer must be embedded to have forward compatible implementations.
...
func (UnimplementedExtensionHostServiceServer) Connect(*ExtensionRequest, ExtensionHostService_ConnectServer) error {
...
func _ExtensionHostService_Connect_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ExtensionHostServiceServer).Connect(m, &extensionHostServiceConnectServer{ServerStream: stream})
}

type ExtensionHostService_ConnectServer interface {
	Send(*ExtensionResponse) error
	grpc.ServerStream
}

type extensionHostServiceConnectServer struct {
	grpc.ServerStream
}

func (x *extensionHostServiceConnectServer) Send(m *ExtensionResponse) error {
